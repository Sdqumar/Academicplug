...
function RegistrationForm() {
    ...
    const validationSchema = Yup.object({
        ...
        password: Yup.string().required('Required').matches(lowercaseRegex, 'One lowercase required!').matches(numericRegex, 'One number required!').min(4, 'Minimum 4 character required!'),
